...
cryptographically verify a reproduction attestation. The sealed `.docx` is 4,575 bytes and the
`.odt` 3,531 bytes, and the packed project payload is *byte-identical between them* — parity that
