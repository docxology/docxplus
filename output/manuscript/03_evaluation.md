...
cryptographically verify a reproduction attestation. The sealed `.docx` is 4,602 bytes and the
`.odt` 3,665 bytes, and the packed project payload is *byte-identical between them* — parity that
